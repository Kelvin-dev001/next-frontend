...
const promoCards = [
  {
    ...
    subtitle:
      "Save big on select phones + free accessories this week. Shop sweet deals before they are gone.",
    cta: "Shop Valentine Deals",
    href: "/products?tag=valentine",
    image: "https://res.cloudinary.com/dltfgasbb/image/upload/v1770955232/valentines_floouc.jpg",
    alt: "Valentines limited time phone offer announcement",
    tone: "soft",
  },
  {
    id: "offer-1",
