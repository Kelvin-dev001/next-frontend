        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
          {list.map((brand, idx) => (
            <Link
              ...
              prefetch={false}
              className="flex min-h-[120px] flex-col items-center gap-2 rounded-[10px] border border-black/5 bg-white p-4 text-center shadow-[0_5px_18px_rgba(7,89,133,0.08)] transition hover:shadow-md"
            >
              ...
              <span className="rounded-full bg-brand-700 px-2 py-0.5 text-[0.68rem] font-bold tracking-wide text-white">Shop now</span>
            </Link>
          ))}
        </div>
      </div>
