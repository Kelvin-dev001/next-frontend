...
import { Dialog, DialogTitle, DialogContent, DialogActions, TextField, Button, Stack, Avatar } from "@mui/material";
...
export default function CategoryForm({ category, onSuccess, onCancel }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      else if (icon) formData.append("icon", icon);

      if (category) await Api.put(`/categories/${category._id}`, formData);
